...
//        }
//        makeA(2, 100000, 200, 10, 1234, "/home/drproduck/Documents/HMM/data/triA2_restarts");
...
//        columnTransposeWithBigram();
    ...
    public static void columnTransposeWithBigram() throws Exception{
        int dim = 4;
        Scanner in = new Scanner(new BufferedReader(new FileReader("/home/drproduck/Documents/HMM/data/biA4")));
        ...
        int[][] baseText = readCipherMatrix("/home/drproduck/Documents/HMM/data/408plaintransposed");
        int[] col = new int[17];
        for (int i = 0; i < 17; i++) {
            col[i] = i;
        }
        ...
        BayesianHMM HMM = new BayesianHMM(dim, 26, flattenMatrix(baseText, col), prior);
        HMM.A = A;
    ...
    public static void columnTransposeWithTrigram() throws Exception{
        int dim = 2;
        Scanner in = new Scanner(new BufferedReader(new FileReader("/home/drproduck/Documents/HMM/data/triA2")));
    ...
    public static double testLogProb(BayesianHMM HMM, int[] seq, int dim, int iter, int restart) {
        double prob;
        double bestLogProb = Double.NEGATIVE_INFINITY;
        for (int i = 0; i < restart; i++) {
            HMM.firstRestart = true;
