...
public class BayesGibbs {
    ...
    public BayesGibbs(double[] pi, double[][] baseTransit, int[] tags, int[] words, int n_tags, int n_words) {
        this.pi = pi;
...
//        double[][] saveEmit = util.Helper.deepClone(emitCount);
//        dou
//    }
