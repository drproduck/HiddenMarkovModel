...
public class MakeCipher {
    public static void main(String[] args) throws Exception{
        String dir = "/home/drproduck/Documents/em.HMM/brown_nolines.txt";
        BufferedWriter writer;
        int[][] init = {{1000, 500, 2134}, {10000, 400, 3211}, {100000, 300,1234}};
        for (int i = 0; i < init.length; i++) {
            int[] plainText = Helper.textProcess(dir, true, init[i][0], init[i][1]);
            int[] dict = Helper.permuteKey("random", init[i][2]);
