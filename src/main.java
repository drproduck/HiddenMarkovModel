...
//        String dir = "/home/drproduck/Documents/HMM/simple_cipher/simple_cipher_length=300";
//        System.out.println("Solving cipher of length 300");
//        simpleCipher(300, dir);
//        dir = "/home/drproduck/Documents/HMM/simple_cipher/simple_cipher_length=400";
//        System.out.println("Solving cipher of length 400");
//        simpleCipher(400, dir);
//        dir = "/home/drproduck/Documents/HMM/simple_cipher/simple_cipher_length=500";
...
//        BufferedWriter writer = new BufferedWriter(new FileWriter("408.txt"));
//        int[] plain = util.plain("plain.txt");
//        for (int i = 0; i < 408; i++) {
//            writer.write(plain[i]+" ");
//        }
//        writer.newLine();
//        int[] cipher = util.read408("408t");
//        for (int i = 0; i < 408; i++) {
...
//        writer.close();
    ...
    public static void cipher408() throws Exception {
        ...
        Scanner sc = new Scanner(new BufferedReader(new FileReader("/home/drproduck/Documents/HMM/data/bigram")));
        ...
        int maxIters = 200;
        int T = 408;
        int[] cipher = util.read408("/home/drproduck/Documents/HMM/data/408ciphercleaned");
        int[] plain = util.plain("/home/drproduck/Documents/HMM/data/408plaincleaned");
...
//                acc /= len;
    ...
    /**
     * This one uses BayesianHMM and MDir
     * @throws Exception
     */
...
//        double[][] A = util.digraph();
        ...
        BayesianHMM HMM = new BayesianHMM(n_tags, n_words, T, prior);
        HMM.A = A;
        HMM.seq = cipher;
        int[] n = {100};
...
//        double[][] A = util.digraph();
        ...
        BayesianHMM HMM = new BayesianHMM(n_states, n_obs, T, prior);
        HMM.A = A;
        HMM.seq = cipher;
        int[] n = {100};
...
//    public static int postMap(int[] sol_num, int[] plain, int[] argmax, int len) {
//        double acc = 0;
//        for (int k = 0; k < len; k++) {
//            sol_num[k] = argmax[cipher[k]];
//            if (sol_num[k] == plain[k]) {
...
//    }
    ...
    public static void testEnglish() throws Exception {
        int[] txt_obs = util.textProcess("/home/drproduck/Documents/hmm/src/brown_nolines.txt", true, 100000, 100000);
        ...
        BayesianHMM trainer = new BayesianHMM(26, 26, txt_obs, prior);
        ...
        outputWriter.write(util.display2(trainer.B));
        outputWriter.newLine();
    ...
    public static void basicExample() {
        ...
        BayesianHMM test = new BayesianHMM(2, 3, 3, dirPrior);
