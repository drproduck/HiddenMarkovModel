...
/**
 * Trigram HMM. This version uses log-sum-exp is can be very slow but does not suffer from underflow
 */
...
//        System.out.println(logSumExp(a));
        ...
        double[][][] trigram = Helper.readTrigram("/home/drproduck/Documents/em.HMM/data/logtrigram.txt");
...
//        em.HMM.train(200, false, 8781939572407739913L, true);
//        em.HMM.train(200, false, 1209845257843231593L, true);
//        em.HMM.train(100, false, 1236, true);
        stop = System.nanoTime();
        ...
        System.out.println(Helper.display2(HMM.B));
...
//        int[] argmax = new int[em.HMM.nw];
//                for (int k = 0; k < em.HMM.nw; k++) {
//                    double max = em.HMM.B[0][k];
//                    int arg = 0;
//                    for (int l = 1; l < em.HMM.nt; l++) {
//                        if (max < em.HMM.B[l][k]) {
//                            max = em.HMM.B[l][k];
//                            arg = l;
//                        }
