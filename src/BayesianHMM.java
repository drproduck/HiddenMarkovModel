...
public class BayesianHMM {
    ...
    public BayesianHMM(int n_states, int n_obs, int[] observations, MDir dirPrior) {
        this(n_states, n_obs, observations.length, dirPrior);
        seq = observations;
    }

    public BayesianHMM(int n_states, int n_obs, int time, MDir dirPrior) {
        len = time;
        this.nt = n_states;
        this.nw = n_obs;
        A = new double[nt][nt];
